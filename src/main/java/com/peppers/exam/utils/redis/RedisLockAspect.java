...
public class RedisLockAspect {
     ...
     */
    @Pointcut("@annotation(com.peppers.exam.utils.redis.RedisLockAnnotation)")
    ...
    private Method resolveMethod(ProceedingJoinPoint pjp) {
        ...
        if (method == null){
            throw new IllegalArgumentException("cannot resolve target method: "+ signature.getMethod().getName());
        }
        return method;
    }
